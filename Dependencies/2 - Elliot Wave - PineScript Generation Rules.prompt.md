...
- **For pivot labels at specific points: use size=size.small to ensure readability while keeping labels compact**
- **For pivot labels: use textalign=text.align_center (not text.align_left) to center-align label text at pivot points**
