...
- **Subwave label/line color uses `swLabelTransp` (user input, default 0) — always `color.new(wave_color, swLabelTransp)`. Never hardcode a transparency value for subwave colors.**
